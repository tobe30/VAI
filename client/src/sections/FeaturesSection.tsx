...
export default function FeaturesSection() {
  return (
    <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
      <SectionTitle
        text1="Features"
        text2="Everything You Need to Prepare"
        text3="Built for engineers who take interview prep seriously."
      />
      ...
      <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
        {featuresData.map((feature, index) => (
          <motion.div
            key={index}
            className={`${index === 1 ? 'p-px rounded-[13px] bg-linear-to-br from-blue-600 to-slate-800' : ''}`}
      ...
      <div className="mt-40 relative mx-auto max-w-5xl">
        ...
        >
          Vai helps you prepare for your next interview with confidence a complete cheat sheet to help you pass like a pro. 
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          ...
          >
            <img
              ...
              width={1000}
              height={500}
              className="hover:-translate-y-0.5 rounded-xl transition duration-300"
            />
            <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">
              Better design with highest revenue and profits
            </h3>
            <p className="text-slate-300 mt-2">
              VAI empowers you to Learn Smartly and Practice effortlessly.
            </p>
            <a
              href=""
